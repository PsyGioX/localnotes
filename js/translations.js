...
const translations = {
    en: {
        ...
        notifScopeHint: "Local Notes has no server, so reminders only fire while this app is open (on load, when you switch back to the tab, and every 15 minutes) — not as background push notifications when the app is fully closed.",
        ...
        notifEnable: "Remind me about due and overdue notes",
        notifOverdueBody: "This note is overdue",
        notifDueTodayBody: "Due today",
        newTag: "New tag",
    ...
    ru: {
        ...
        notifBtn: "Напоминания",
        notifSettingsTitle: "Напоминания",
        notifScopeHint: "У Local Notes нет сервера, поэтому напоминания срабатывают только пока приложение открыто (при загрузке, при возврате на вкладку и каждые 15 минут) — а не как фоновые push-уведомления при полностью закрытом приложении.",
        notifUnsupported: "Уведомления не поддерживаются в этом браузере.",
        notifBlocked: "Уведомления заблокированы для этого сайта в настройках браузера.",
        notifEnable: "Напоминать о заметках с истекающим и истёкшим сроком",
        notifOverdueBody: "Срок этой заметки истёк",
        notifDueTodayBody: "Срок сегодня",
        newTag: "Новый тег",
