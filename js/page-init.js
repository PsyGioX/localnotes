...
(function() {
    var sheets = [
        ...
        '/css/highlight.css?v=1.9.6',
        '/localnoteseditor/styles.css?v=1.9.6',
        '/css/editor-modal.css?v=1.9.6',
        '/css/apple.css?v=1.9.6',
        '/css/tags-calendar.css?v=1.9.6',
        '/css/workspaces.css?v=1.9.6',
        '/css/task-board.css?v=1.9.6'
    ];
