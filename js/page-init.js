...
(function() {
    var sheets = [
        ...
        '/css/highlight.css?v=1.9.8',
        '/localnoteseditor/styles.css?v=1.9.8',
        '/css/editor-modal.css?v=1.9.8',
        '/css/apple.css?v=1.9.8',
        '/css/tags-calendar.css?v=1.9.8',
        '/css/workspaces.css?v=1.9.8',
        '/css/task-board.css?v=1.9.8'
    ];
