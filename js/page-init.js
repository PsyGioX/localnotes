...
(function() {
    var sheets = [
        ...
        '/css/highlight.css?v=1.7.0',
        '/localnoteseditor/styles.css?v=1.7.0',
        '/css/editor-modal.css?v=1.7.0',
        '/css/apple.css?v=1.7.0',
        '/css/tags-calendar.css?v=1.7.0',
        '/css/workspaces.css?v=1.7.0'
    ];
