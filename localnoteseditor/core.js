...
class LocalNotesEditor {
    ...
    _insertTemplate(type) {
        ...
        var templates = {
            meeting: [
                h('h2','','<i class="bi bi-copy"></i> ' + _('tplMeetingTitle','Meeting Notes')),
            ...
            brainstorm: [
                ...
                '<ul><li></li></ul>',
                h('h3','','<i class="bi bi-link-45deg"></i> ' + _('tplResources','Resources')),
                '<ul><li></li></ul>',
                br
            ].join(''),
            ...
            lecture: [
                ...
                h('h3','','<i class="bi bi-filetype-md"></i> ' + _('tplNotes','Notes')),
                h('p','',''),
            ...
            flashcard: [
                ...
                h('p','min-height:3em;padding:10px;background:var(--bg-secondary,#111);border-radius:8px;border:1px solid var(--border-color,#333)',''),
                h('h3','','<i class="bi bi-link-45deg"></i> ' + _('tplRelated','Related')),
                h('p','',''),
                br
            ].join(''),
    ...
    _modalEmoji() {
        ...
        categories[_('emojiCatNature','🌍 Nature')]      = ['🌍','🌎','🌏','<i class="bi bi-filetype-html"></i>','🌱','🌿','🍀','🌲','🌳','🌴','🌵','🌾','🌺','🌸','🌼','🌻','🌷','🌹','🥀','💐','🍁','🍂','🍃','☀️','🌤️','⛅','🌦️','🌧️','⛈️','🌩️','🌨️','❄️','☃️','⛄','🌬️','💨','🌊','🌀','🌈','🌂','☂️','🌡️','⛱️','⚡','🔥','💧','🌊','🦁','🐯','🐻','🐼','🐨','🐸','🐵','🙈','🙉','🙊','🐔','🐧','🐦','🐤','🦆','🦅','🦉','🦇','🐺','🐗','🐴','🦄','🐝','🐛','🦋','🐌','🐞','🐜','🦟','🦗','🕷️','🦂','🐢','🐍','🦎','🦖','🦕','🐙','🦑','🦐','🦞','🦀','🐡','🐠','🐟','🐬','🐳','🐋','🦈','🐊','🐅','🐆','🦓','🦍','🦧','🐘','🦛','🦏','🐪','🐫','🦒','🦘','🐃','🐂','🐄','🐎','🐖','🐏','🐑','🦙','🐐','🦌','🐕','🐩','🦮','🐕‍🦺','🐈','🐈‍⬛','🐓','🦃','🦚','🦜','🦢','🦩','🕊️','🐇','🦝','🦨','🦡','🦦','🦥','🐁','🐀','🐿️','🦔'];
        categories[_('emojiCatFood','🍕 Food')]          = ['🍕','🍔','🍟','🌭','🍿','🧂','🥓','🥚','🍳','🧇','🥞','🧈','🍞','🥐','🥨','🥯','🧀','🥗','🥘','🍲','🍛','🍜','🍝','🍠','🥟','🍱','🍤','🍙','🍚','🍘','🍥','🥮','🍢','🧁','🍰','🎂','🍮','🍭','🍬','🍫','🍩','🍪','🌰','🥜','🍯','🍼','🥛','☕','🍵','🧃','🥤','🧋','🍶','🍺','🍻','🥂','🍷','🥃','🍸','🍹','🧉','🍾','🧊','🥄','🍴','🍽️','🥢','🧆','🥙','🧇','🥗','🥫'];
        categories[_('emojiCatSymbols','⚡ Symbols')]    = ['⚡','🔥','💧','⭐','🌟','✨','💥','❄️','🌈','☀️','🌙','⚙️','🔑','🗝️','<i class="bi bi-file-earmark-lock"></i>','🔓','💡','🔔','🔕','🎵','🎶','🎼','📌','📍','✅','❌','❓','❗','💯','🔴','🟠','🟡','🟢','🔵','🟣','⚫','⚪','🟤','🔶','🔷','🔸','🔹','🔺','🔻','💠','🔘','🔲','🔳','▪️','▫️','◾','◽','◼️','◻️','⬛','⬜','🔈','🔉','🔊','📢','📣','🔇','🔔','🔕','📳','📴','📵','📶','📳','🚫','⛔','📛','🔞','🔃','🔄','🔙','🔚','🔛','🔜','🔝','🛐','⚛️','🉑','☑️','✔️','✖️','🔱','📛','🔰','♻️','✅','🈴','🈺','🈷️','✴️','🆚','💟','🆘','❎','🆔','🆕','🆙','🆒','🆓','🆖','🅰️','🅱️','🆎','🆑','🅾️','🆗','🅿️','🆙','🆒'];
        var tabs = '', panels = '';
