...
const STATIC_FILES = [
    ...
    // Данные переводов (маленькие файлы по языку вместо одного большого)
    '/locales/en.json',
    '/locales/ru.json',
    '/locales/ua.json',
    '/locales/pl.json',
    ...
    '/locales/mk.json',
    '/locales/sl.json',
    '/locales/site/en.json',
    '/locales/site/ru.json',
    '/locales/site/ua.json',
    '/locales/site/pl.json',
    '/locales/site/cs.json',
    '/locales/site/sk.json',
    '/locales/site/bg.json',
    '/locales/site/hr.json',
    '/locales/site/sr.json',
    '/locales/site/bs.json',
    '/locales/site/mk.json',
    '/locales/site/sl.json',
